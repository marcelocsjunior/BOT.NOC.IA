...
Índice rápido da documentação versionada do projeto, incluindo baseline, deploy, segurança, operação, DM assistiva e toolkit operacional.
...
- [DEPLOY.md](DEPLOY.md) — deploy seguro do bot, escopo, smoke test da DM e rollback
